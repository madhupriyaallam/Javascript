...
function refreshTables() {
  let i = 1;
  tableId.innerHTML = ""; //to delete the html content inside that element
...
function showMenu() {
  menuId.innerHTML = ""; //to delete the html content inside that element
  let i = 1;
...
function searchTable() {
  ...
  if (num[1] != undefined && num[1] != "") { // taking 2nd element in array i.e table number
